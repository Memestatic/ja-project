...
public class WavFileProcessor
{
	...
	{
		using var stream = browserFile.OpenReadStream(5 * 1024 * 1024);
		using var memoryStream = new MemoryStream(5 * 1024 * 1024);
		...
		{
			int sample = BitConverter.ToInt16(data, i * bytesPerSample);
